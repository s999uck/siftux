...
const securityFeatures = [
  {
    icon: Shield,
    title: "Sandboxed RAG processing",
    description: "Knowledge bases processed in isolated, secured environments.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "End-to-end encryption",
    description: "Knowledge bases encrypted at rest and in transit.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Complete audit logs",
    description: "Every query and interaction fully logged for compliance.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Role-based access",
    description: "Granular permissions control for enterprise teams.",
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Enterprise
            <br />
            <span className="text-muted-foreground">security built-in.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your knowledge bases are secure, compliant, and protected. Enterprise-grade security ensures complete control over sensitive information.
            </p>
          </div>
        </div>
