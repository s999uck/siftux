...
const testimonials = [
  {
    ...
    metric: { value: "60%", label: "Faster onboarding" },
  },
  {
    quote: "We now answer customer questions across Slack, Teams, and our helpdesk automatically using our unified knowledge base.",
    author: "Marcus Webb",
    role: "Head of Support",
    company: "Flux Systems",
    metric: { value: "5000+", label: "Queries answered daily" },
  },
  {
    quote: "The multi-channel integration is powerful. Our support team spends 70% less time on repetitive questions.",
    author: "Elena Rodriguez",
    role: "VP Customer Success",
    company: "Beacon AI",
    metric: { value: "70%", label: "Time savings" },
  },
  {
    quote: "Enterprise security was essential. The encryption and audit trails give us full compliance confidence.",
    author: "James Liu",
    role: "CISO",
    company: "Prism Analytics",
    metric: { value: "SOC 2", label: "Certified" },
  },
];
...
export function TestimonialsSection() {
  ...
  useEffect(() => {
    // Generate stable ASCII pattern on client only to avoid hydration mismatch
    const pattern = Array.from({ length: 60 }, (_, i) =>
      Array.from({ length: 100 }, () => {
        // Simple deterministic pseudo-random based on position
        const seed = (i * 100 + Date.now()) % 1000;
        return (seed * 9301 + 49297) % 233280 / 233280 > 0.7 ? '"' : ' ';
      }).join("")
    ).join("\n");
