...
const steps = [
  {
    ...
    title: "Ingest",
    subtitle: "your data",
    description: "Upload documents (PDF, DOCX, CSV) or sync from Google Drive, Notion, Confluence, and websites. Automatic extraction and intelligent chunking.",
    code: `const kb = new KnowledgeBase({
  ...
  },
  {
    ...
    description: "Link your knowledge base to Slack, WhatsApp, and other key platforms. Real-time sync and API integrations available.",
    code: `await kb.connectChannels({
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Connect.</span>
